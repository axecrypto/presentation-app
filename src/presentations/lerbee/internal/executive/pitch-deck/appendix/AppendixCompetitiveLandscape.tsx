...
import { BarChart3, CheckCircle, Brain } from 'lucide-react';

export const AppendixCompetitiveLandscape = () => {
  const competitors = [
    {
      platform: 'Temu / Shein',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-surface rounded-xl p-6 border border-default">
            <h3 className="text-lg font-semibold text-primary mb-4">Market Gaps We Fill</h3>
            <ul className="space-y-2 text-secondary">
              <li>• Trust in cross-border commerce</li>
              <li>• Personal shopping at scale</li>
          ...
          <div className="bg-surface rounded-xl p-6 border border-default">
            <h3 className="text-lg font-semibold text-primary mb-4">Competitive Advantages</h3>
            <ul className="space-y-2 text-secondary">
              <li>• Zero inventory risk</li>
              <li>• Network effects in micro-communities</li>
              <li>• AI + human hybrid model</li>
