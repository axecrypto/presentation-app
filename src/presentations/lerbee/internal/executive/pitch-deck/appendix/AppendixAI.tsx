      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-primary mb-4">
            AI & Human Collaboration Details
          </h1>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-surface rounded-xl p-8 border border-default">
            ...
            <p className="text-secondary mb-6">Automation Layer - Full List</p>
          ...
          <div className="bg-surface rounded-xl p-8 border border-lerbee-yellow">
            ...
            <p className="text-secondary mb-6">Trust Layer - Full List</p>
        ...
        <div className="bg-surface rounded-xl p-8 border border-default mb-8">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <h3 className="text-xl font-semibold text-primary">AI + Human Flywheel Details</h3>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-surface rounded-xl p-6 border border-default">
            <h3 className="text-lg font-semibold text-primary mb-4">AI Infrastructure</h3>
          ...
          <div className="bg-surface rounded-xl p-6 border border-default">
            <h3 className="text-lg font-semibold text-primary mb-4">Human Value-Add</h3>
            <ul className="space-y-2 text-secondary">
              <li>• Cultural context & nuance</li>
              <li>• Personal style expertise</li>
