...
export const AppendixProductMarketFit = () => {
  const indicators = [
    {
      icon: Brain,
      title: 'Retention',
      metrics: [
        ...
        'Cohort retention improving month-over-month'
      ]
    },
    {
      icon: MessageCircle,
  ...
  const confirmedBehaviors = [
    ...
    'Shoppers create repeat buyer relationships',
    'Communities form around specific shoppers'
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-surface rounded-xl p-8 border border-lerbee-yellow mb-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-xl font-semibold text-primary">All Confirmed Behaviors</h3>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-surface rounded-xl p-6 border border-default text-center">
            ...
            <p className="text-secondary">Would recommend to friend</p>
          </div>
          <div className="bg-surface rounded-xl p-6 border border-default text-center">
            <p className="text-3xl font-bold text-primary mb-2">6.2x</p>
            <p className="text-secondary">Viral coefficient</p>
          </div>
        </div>
      </div>
    </div>
