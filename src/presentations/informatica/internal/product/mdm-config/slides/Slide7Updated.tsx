  ...
  const impacts: Impact[] = [
    {
      ...
      icon: Clock,
      color: "from-orange-600 to-orange-700", // Using Informatica orange
      bgColor: "bg-orange-600", // Solid color for better contrast
    ...
    },
    {
      ...
      icon: Users,
      color: "from-blue-600 to-blue-700", // Professional blue
      bgColor: "bg-blue-600",
    ...
    },
    {
      ...
      icon: Target,
      color: "from-purple-700 to-purple-800", // Darker purple for contrast
    ...
    },
    {
      ...
      icon: Rocket,
      color: "from-green-600 to-green-700", // Material green
  ...
  const metrics = [
    {
      ...
      icon: Clock,
      color: "text-blue-400",
      bgColor: "bg-gray-800", // Dark background for contrast
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-8 overflow-hidden relative">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-orange-600 to-purple-700 rounded-full blur-3xl transform translate-x-1/2 -translate-y-1/2"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-blue-600 to-green-600 rounded-full blur-3xl transform -translate-x-1/2 translate-y-1/2"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
            ...
            return (
              <div
                ...
                className={`
                  ...
                  ${isActive ? 
                    `${impact.bgColor} border-white shadow-2xl scale-105` : 
              ...
              >
                ...
                {/* Before/After Indicator - High Contrast */}
                <div className={`mt-4 p-3 rounded-lg border transition-all duration-300 ${
                  isActive ? 'bg-black/30 border-white/30' : 'bg-gray-900/50 border-gray-700'
                }`}>
                  <div className="flex items-center justify-between text-xs">
                    <div className={isActive ? "text-white/80" : "text-red-400"}>
                      <div className="font-bold">{impact.beforeAfter.before.value}</div>
                      <div>{impact.beforeAfter.before.label}</div>
                    </div>
                    <ArrowRight size={16} className={isActive ? "text-white/60" : "text-gray-400"} />
                    <div className={isActive ? "text-white" : "text-green-400"}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="bg-gray-800 backdrop-blur-lg rounded-xl border border-gray-700 p-4">
              <p className="text-base text-gray-300 mb-4">{impacts[activeImpact].description}</p>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {impacts[activeImpact].benefits.map((benefit, index) => (
                  <div
                    key={index}
                    className="flex items-center space-x-2 p-2 bg-gray-700 rounded-lg border border-gray-600"
                  >
                    ...
                    {metric.stats.map((stat, idx) => (
                      <div key={idx} className="flex justify-between items-center">
                        ...
                        <div className="text-right">
                          ...
                          <span className="text-xs text-gray-500 ml-1">{stat.detail}</span>
                        </div>
                      </div>
                    ))}
                  </div>
        ...
        {/* CTA Section */}
        <div className="bg-gradient-to-r from-orange-600 to-orange-700 rounded-2xl p-8 text-center shadow-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-8 py-3 bg-white text-orange-600 rounded-lg font-bold hover:bg-gray-100 transition-all duration-300 shadow-lg">
              Schedule Demo
            </button>
            <button className="px-8 py-3 bg-orange-800 text-white rounded-lg font-bold hover:bg-orange-900 transition-all duration-300 border border-orange-600">
              Learn More
            </button>
          </div>
        </div>
